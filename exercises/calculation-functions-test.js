...
function testBonusFunctions() {
  ...
  try {
    ...
    console.log(
      "ℹ️ findTransactionsAboveAmount not implemented (bonus function)"
    );
  }
  ...
  try {
    ...
    console.log(
      "ℹ️ calculateMonthOverMonthGrowth not implemented (bonus function)"
    );
  }
...
function runAllTests() {
  ...
  console.log(
    "📝 Testing with sample data containing 30 transactions across 3 months\n"
  );
  ...
  if (testResults.failed === 0) {
    ...
    console.log(
      "🚀 You can now integrate these functions into the capstone project!"
    );
  } else {
    console.log(
    ...
    console.log(
      "   - Check your conditional logic for filtering by type and month"
    );
